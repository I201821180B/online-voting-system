<%@ Page Title="" Language="C#" MasterPageFile="~/admin/admin.Master" AutoEventWireup="true" CodeBehind="default.aspx.cs" Inherits="online_voting_system.admin._default" %>
        ...
        <div class="container-fluid">
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-10">
                    <asp:Button ID="admin_login_btn" Text="Login" runat="server" CssClass="btn btn-primary" />
                </div>
            </div>
        </div>
</asp:Content>
